...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        .addField(`Links:`,`- [Youtube Channel](https://youtube.com/c/decoders1)\n- [Discord Server](https://discord.gg/decoders)`,true)
        .setTimestamp()
        .setFooter(`Requested by ${interaction.user.username} | | DECΩDERS™| Cedits : Zero | 0_0`, interaction.user.displayAvatarURL());
